...
- `AGENTS.md`, `CONTRIBUTE.md`, PR templates, or issue forms are being updated
...
4. Keep `AGENTS.md`, `CLAUDE.md`, `GEMINI.md`, `CONTRIBUTE.md`, and `.github/pull_request_template.md` aligned when workflow wording changes.
...
- Run any required local verification from `CONTRIBUTE.md`.
